...
public class User implements Serializable{ 
	...
	public User(Integer id, String username, String password, String phone, String email, Integer gender,
			String createUser, Date createTime, String modifiedUser, Date modifiedTime) {
		super();
		this.id = id;
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", phone=" + phone + ", email="
				+ email + ", gender=" + gender + ", createUser=" + createUser + ", createTime=" + createTime
